...
@section('title', 'Training Card Dashboard')
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Training Card</a></li>
                            ...
                            <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p class="align-self-center mb-0 user-info"></p>
                                        </td>
                                        <td>
