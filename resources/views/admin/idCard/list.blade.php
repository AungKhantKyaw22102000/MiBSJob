...
@section('title', 'ID Card Dashboard')
                            ...
                            <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="inv-number">{{ $idCard->employee_id }}</span></td>
                                        <td>
                                            <p class="align-self-center mb-0 user-name"> {{ $idCard->name }} </p>
                                        </td>
                                        <td>
                                            <p class="align-self-center mb-0 user-work"> {{ $idCard->department }} </p>
                                        </td>
                                        <td>
                                            <p class="align-self-center mb-0 user-location">{{ $idCard->address }}</p>
                                        </td>
                                        <td>
